""" Simple Unet build without sequentials to test seggradcam layer accessment """
...
def make_UNetSimple(n_channels, n_classes, **params):
    ...
    model = UNetSimple(n_channels, n_classes).to(device)
...
class UNetSimple(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.down_inc = DoubleConv(n_channels, 64)
